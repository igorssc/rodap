...
import metropolitanasImg from "../assets/schedules/metropolitana.webp";
import riberaoDasNevesImg from "../assets/schedules/ribeirao-das-neves.webp";
import urbanasBHImg from "../assets/schedules/urbanas-bh.webp";
import urbanasSantaLuziaImg from "../assets/schedules/urbanas-santa-luzia.webp";
            ...
            {[
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Title className="!text-xl sm:!text-2xl lg:!text-3xl text-center">
                    {v.name}
                  </Title>
                </div>
                <Image
